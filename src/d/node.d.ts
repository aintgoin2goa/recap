...
declare module "fs" {
    ...
    export function readFileSync(filename: string, encoding: any): string;
    export function writeFile(filename: string, data: any, encoding?: any, callback?: Function): void;
