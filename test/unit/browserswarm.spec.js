...
describe("Swarm", function(){
	...
	xit("Will pass on any 'message' events from the browser");

	xit("Will pass on any 'error' events from the browser, and disconnect the process");

	xit("Will fire a 'available' event when a browser completes it's task");
